...
type TransactionModel struct {
	...
	TransactionDate   time.Time `gorm:"column:transaction_date;not null"` // string 대신 time.Time 추천!
...
type CreateTransactionRequest struct {
	...
	TransactionDate   time.Time `json:"transaction_date" binding:"required"` // 또는 time.Time
...
type UpdateTransaction struct {
	...
	TransactionDate   time.Time `json:"transaction_date"` // 또는 time.Time
